...
test.describe('Word List - Display & Pagination', () => {
  test('should display the word list table on page load', async ({ page, request }) => {
  ...
  test('should show word title and description columns', async ({ page, request }) => {
    await authenticatePage(page, request);
    await page.waitForSelector('table tbody tr', { timeout: 10000 });
  ...
  test('should show pagination info in footer', async ({ page, request }) => {
    await authenticatePage(page, request);
    await page.waitForSelector('table tbody tr', { timeout: 10000 });
